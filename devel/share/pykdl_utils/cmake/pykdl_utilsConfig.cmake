...
if("TRUE" STREQUAL "TRUE")
  set(pykdl_utils_SOURCE_PREFIX /home/binx/Documents/Research/Crazy/src/hrl-kdl/pykdl_utils)
  set(pykdl_utils_DEVEL_PREFIX /home/binx/Documents/Research/Crazy/devel)
  ...
  set(pykdl_utils_INSTALL_PREFIX /home/binx/Documents/Research/Crazy/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pykdl_utils' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Kelsey Hawkins <kphawkins@gatech.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'pykdl_utils' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/binx/Documents/Research/Crazy/src/hrl-kdl/pykdl_utils/${idir}'.  Ask the maintainer 'Kelsey Hawkins <kphawkins@gatech.edu>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${pykdl_utils_dep}_FOUND)
      find_package(${pykdl_utils_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${pykdl_utils_dep} REQUIRED ${depend_list})
  endif()
