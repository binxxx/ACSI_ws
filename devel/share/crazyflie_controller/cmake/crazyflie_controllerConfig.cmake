...
if("TRUE" STREQUAL "TRUE")
  set(crazyflie_controller_SOURCE_PREFIX /home/binx/Documents/Research/Crazy/src/crazyflie_ros/crazyflie_controller)
  set(crazyflie_controller_DEVEL_PREFIX /home/binx/Documents/Research/Crazy/devel)
  ...
  set(crazyflie_controller_INSTALL_PREFIX /home/binx/Documents/Research/Crazy/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'crazyflie_controller' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Wolfgang Hoenig <whoenig@usc.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'crazyflie_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/binx/Documents/Research/Crazy/src/crazyflie_ros/crazyflie_controller/${idir}'.  Ask the maintainer 'Wolfgang Hoenig <whoenig@usc.edu>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${crazyflie_controller_dep}_FOUND)
      find_package(${crazyflie_controller_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${crazyflie_controller_dep} REQUIRED ${depend_list})
  endif()
